export const settings = {
  ...
  pastel: {
    ...
    "--primary-bg-color": "#fefce8",
    "--secondary-bg-color": "#e0f2fe",
    "--button-text-color": "#0ea5e9",
    "--gradient-bg": "linear-gradient(135deg, #ffedd5, #c7d2fe)"
  },
  dark: {
